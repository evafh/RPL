    ...
    <body>
        ...
        <?php
            ...
            if (($dompetRow) && ($bulanRow = pg_fetch_assoc($resultbulan))) {
                ...
                echo "<a href='saya_Rencana.php?id_dompet=" . $idDompet . "&bulan=" . $bulan_final . "'><button class='button'>Rencana Saya</button></a>";
            } elseif ( $dompetRow ) {
                $idDompet = $dompetRow['id_dompet'];
        ...
        <?php
            ...
            if (($dompetRow) && ($bulanRow = pg_fetch_assoc($resultbulan))) {
                ...
                $bulan_final = "$tahun-$bulan";
                echo "<a href='saya_laporan.php?id_dompet=" . $idDompet . "&bulan=" . $bulan_final . "'><button class='button'>Laporan Saya</button></a>";
            } elseif ( $dompetRow ) {
                $idDompet = $dompetRow['id_dompet'];
                echo "<a href='saya_Transaksi.php'><button class='button'>Laporan Saya</button></a>";
            } else {
                echo "<a href='saya_Dompet.php'><button class='button'>Laporan Saya</button></a>";
            }
